...
### Phase 2.6.1: Refactor kelpie-runtime ⏳ PENDING
...
**Files to modify:**
- `crates/kelpie-runtime/src/dispatcher.rs` (Dispatcher struct, run method)
- `crates/kelpie-runtime/src/handle.rs` (DispatcherHandle, all spawn calls)
- `crates/kelpie-runtime/src/runtime.rs` (Runtime instantiation)
- `crates/kelpie-runtime/tests/*.rs` (Test updates)

**Success Criteria:**
- [ ] Dispatcher<A, S, R: Runtime> compiles
- [ ] All kelpie-runtime tests pass with TokioRuntime
- [ ] No direct tokio::spawn/sleep in kelpie-runtime

### Phase 2.6.2: Update kelpie-server Production Code ⏳ PENDING
...
### Phase 2.6.3: Add madsim to kelpie-server ⏳ PENDING
...
### Phase 2.6.4: Port Pilot Test ⏳ PENDING
...
- [ ] kelpie-runtime refactored to use Runtime parameter
- [ ] kelpie-server production code uses Runtime
- [ ] madsim added to kelpie-server dev-dependencies
- [ ] Pilot test ported and passing
- [ ] All 26 kelpie-server tests ported
- [ ] Production binary still works with TokioRuntime
- [ ] No direct tokio::spawn/sleep in production code
...
|----------|-------|--------|-------|
| Claude-1 | 2.6.1 | TODO | Starting with kelpie-runtime |
