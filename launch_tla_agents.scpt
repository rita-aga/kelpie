-- AppleScript to launch 10 Claude agents in Terminal tabs

tell application "Terminal"
	activate

	-- Issue #6: KelpieLease
	do script "cd /Users/seshendranalla/Development/kelpie-issue-6 && claude --model opus \"Work on GitHub issue #6: Create KelpieLease.tla spec.
...
- crates/kelpie-registry/src/fdb.rs (lease implementation)\""
	...
	-- Issue #7: KelpieMigration
	tell application "System Events" to keystroke "t" using command down
	delay 0.5
	do script "cd /Users/seshendranalla/Development/kelpie-issue-7 && claude --model opus \"Work on GitHub issue #7: Create KelpieMigration.tla spec.
...
- crates/kelpie-registry/src/lib.rs (placement management)\"" in front window

	delay 1

	-- Issue #8: KelpieActorLifecycle
	tell application "System Events" to keystroke "t" using command down
	delay 0.5
	do script "cd /Users/seshendranalla/Development/kelpie-issue-8 && claude --model opus \"Work on GitHub issue #8: Create KelpieActorLifecycle.tla spec.
...
- crates/kelpie-runtime/src/dispatcher.rs (lifecycle management)\"" in front window

	delay 1

	-- Issue #9: KelpieFDBTransaction
	tell application "System Events" to keystroke "t" using command down
	delay 0.5
	do script "cd /Users/seshendranalla/Development/kelpie-issue-9 && claude --model opus \"Work on GitHub issue #9: Create KelpieFDBTransaction.tla spec.
...
- crates/kelpie-storage/src/fdb.rs (transaction wrapper)\"" in front window

	delay 1

	-- Issue #10: KelpieTeleport
	tell application "System Events" to keystroke "t" using command down
	delay 0.5
	do script "cd /Users/seshendranalla/Development/kelpie-issue-10 && claude --model opus \"Work on GitHub issue #10: Create KelpieTeleport.tla spec.
...
- crates/kelpie-sandbox/src/snapshot.rs (snapshot types)\"" in front window

	delay 1

	-- Issue #11: KelpieClusterMembership
	tell application "System Events" to keystroke "t" using command down
	delay 0.5
	do script "cd /Users/seshendranalla/Development/kelpie-issue-11 && claude --model opus \"Work on GitHub issue #11: Create KelpieClusterMembership.tla spec.
...
- NoSplitBrain: Partitioned nodes don't both think they're primary
...
- docs/tla/KelpieRegistry.tla (node state model)\"" in front window

	delay 1

	-- Issue #12: SingleActivation Liveness
	tell application "System Events" to keystroke "t" using command down
	delay 0.5
	do script "cd /Users/seshendranalla/Development/kelpie-issue-12 && claude --model opus \"Work on GitHub issue #12: Add liveness properties to KelpieSingleActivation.tla.
...
2. Model FDB transaction semantics explicitly (don't just assume atomicity)
...
- docs/tla/README.md (liveness properties needed section)\"" in front window

	delay 1

	-- Issue #13: Registry Liveness
	tell application "System Events" to keystroke "t" using command down
	delay 0.5
	do script "cd /Users/seshendranalla/Development/kelpie-issue-13 && claude --model opus \"Work on GitHub issue #13: Add liveness properties to KelpieRegistry.tla.
...
- docs/tla/README.md (fixes needed section)\"" in front window

	delay 1

	-- Issue #14: ActorState Fix
	tell application "System Events" to keystroke "t" using command down
	delay 0.5
	do script "cd /Users/seshendranalla/Development/kelpie-issue-14 && claude --model opus \"Work on GitHub issue #14: Fix RollbackCorrectness invariant in KelpieActorState.tla.
...
- crates/kelpie-storage/src/lib.rs (rollback implementation)\"" in front window

	delay 1

	-- Issue #15: WAL Liveness
	tell application "System Events" to keystroke "t" using command down
	delay 0.5
	do script "cd /Users/seshendranalla/Development/kelpie-issue-15 && claude --model opus \"Work on GitHub issue #15: Add liveness properties to KelpieWAL.tla.
